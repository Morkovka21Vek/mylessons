...
static esp_err_t html_get_handler(httpd_req_t *req)
{
    ...
    httpd_resp_send(req, fontPage, HTTPD_RESP_USE_STRLEN);
...
static const httpd_uri_t html_struct = {
    .uri       = "/html",
    .method    = HTTP_GET,
...
static esp_err_t ctrl_put_handler(httpd_req_t *req)
{
    ...
    if (buf == '0') {
        ...
        httpd_unregister_uri(req->handle, "/html");
        ...
        httpd_register_uri_handler(req->handle, &html_struct);
...
static httpd_handle_t start_webserver(void)
{
    ...
    if (httpd_start(&server, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(server, &html_struct);
...
//      !gpio_get_level(but_left_up_pin)) gpio_set_level(3, 1);
//  
//  else gpio_set_level(3, 0);
//}
