...
Distance& Distance::operator+=(Distance d)
{
	...
	this->inches = inchesSum - static_cast<int>(inchesSum) + static_cast<int>(inchesSum) % 12;
	return *this;
}
...
int main() {
	...
	std::cout << "Вводите расстояния в формате \"feets inches\". Для выхода нажмите Ctrl+D" << std::endl;
	do {
		std::cout << ">> " << std::flush;
